...
**RESPOND ENTIRELY IN {lang_name}. ALL text including headers, bullet points, examples must be in {lang_name}.**

**MANDATORY FORMAT — use exactly these headers:**
...
2. **{headers["second"]}:** [Next step — include where to go, what to bring]
3. **{headers["third"]}:** [Follow-up — timeline, what to expect]

## {headers["contacts"]}
[List relevant helplines with numbers, government portals, nearest court/authority type. Always include free legal aid if applicable.]

## {headers["notes"]}
[Limitation periods/deadlines, what NOT to do, evidence to preserve, common mistakes]
