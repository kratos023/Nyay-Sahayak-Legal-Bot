...
interface Props { message: Message; outputLanguage?: string; streaming?: boolean; }

export default function MessageBubble({ message, outputLanguage = "English", streaming = false }: Props) {
