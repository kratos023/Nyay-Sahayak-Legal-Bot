...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  function logout() {
    ...
    // NOTE: keep nyay-ui-lang and nyay-io-lang so LanguagePicker pre-highlights
    // the last used language on the next login screen.
    // Only clear nyay-lang-chosen so the picker actually shows again.
    localStorage.removeItem("nyay-lang-chosen");
    localStorage.removeItem("nyay-output-lang");
